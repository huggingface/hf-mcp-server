...
export const spaceArgsSchema = z.object({
	...
	search_query: z.string().optional().describe('For discover operation: Task-focused search query (e.g., "Video Generation", "Object Detection", "Image Generation", "Text Classification")'),
	task_hint: z.string().optional().describe('For discover operation: Optional task hint to refine search (e.g., "text generation", "image classification")'),
